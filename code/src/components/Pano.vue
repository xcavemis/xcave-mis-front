<template>
  <div class="pano-comp">
    <video
      v-if="currentVideo == 'projection501Video'"
      ref="projection501Video"
      autoplay="true"
      playsinline="true"
    ...
    <video
      v-if="currentVideo == 'projection502Video'"
      ref="projection502Video"
      autoplay="true"
      playsinline="true"
      webkitplaysinline="true"
      muted="muted"
...
export default {
  ...
  methods: {
    ...
    setupControls() {
      ...
      controls.registerMethod(
        "leftArrowK",
        new Marzipano.KeyControlMethod(37, "x", -velocity, friction),
        true
      );
      controls.registerMethod(
        "rightArrowK",
        new Marzipano.KeyControlMethod(39, "x", velocity, friction),
        true
      );
      controls.registerMethod(
        "upArrowK",
        new Marzipano.KeyControlMethod(38, "y", -velocity, friction),
        true
      );
      controls.registerMethod(
        "ddownArrowK",
        new Marzipano.KeyControlMethod(40, "y", velocity, friction),
        true
      );
      controls.registerMethod(
        "plusK",
        new Marzipano.KeyControlMethod(107, "zoom", -velocity, friction),
        true
      );
      controls.registerMethod(
        "minusK",
        new Marzipano.KeyControlMethod(109, "zoom", velocity, friction),
        true
      );
      controls.registerMethod(
        "wK",
        new Marzipano.KeyControlMethod(87, "y", -velocity, friction),
        true
      );
      controls.registerMethod(
        "aK",
        new Marzipano.KeyControlMethod(65, "x", -velocity, friction),
        true
      );
      controls.registerMethod(
        "sK",
        new Marzipano.KeyControlMethod(83, "y", velocity, friction),
        true
      );
      controls.registerMethod(
        "dK",
        new Marzipano.KeyControlMethod(68, "x", velocity, friction),
        true
      );
    ...
    buildScenes() {
      return data.scenes.map((data) => {
        ...
        let urlPrefix = isImage
          ? `/media/images/${this.isMobile ? "/mob" : ""}`
          : "/img/scenes/video";
        ...
        let source = null;
        let opts = [{ width: this.isMobile ? 2048 : 16344 }];
        if (isImage) {
    ...
    createInfoHotspot(hotspot) {
      ...
      wrapper.querySelector(".info-hotspot-header").addEventListener(
        "click",
        (e) => {
