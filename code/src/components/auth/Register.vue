<template>
    <div class="register-comp">
        ...
        <form class="register-comp__form">
            ...
            <button class="default-button black register-comp__begin-bt" type="submit" @click="sendData" :disabled="!isValid">CONTINUAR</button>
        </form>
    </div>
</template>
  ...
  methods: {
        ...
        checkForm(type) {
            ...
            if (type == 'confirm-pass') {
                if (this.formData.pass !== this.formData.passConfirm) {
        ...
        validDOB(birth) {
            ...
            let birthStr = birth.substring(0,2) + "/" + birth.substring(2,4) + "/" + birth.substring(4,8)
