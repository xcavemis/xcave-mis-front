  ...
  scenes: [
    {
      id: "mixed301",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-301',
      type: "image",
      name: "mixed 301",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-2783.60, -156.57, -4138.63]
      },
      infoHotspots: [
        {
        ...
        },
        {
          ...
          type: 'link',
          direction: {
            vec3: [2660.09, -579.64, -4181.41],
          },
        },
        {
          vec3: [-3494.14, -1974.86, 2970.38],
          target: "mixed302",
    ...
    },
    {
      ...
      infoHotspots: [
        ...
        },
        {
          ...
          type: 'link',
          direction: {
            vec3: [2057.85, -94.71, -4551.24],
          },
        },
        {
          vec3: [2775.66, -2062.63, -3599.83],
          target: "mixed303",
          title: "GALERIA MISTA 303",
          type: 'link',
          direction: {
            vec3: [4055.22, -88.02, 2916.97],
          },
        },
        {
    ...
    },
    {
      id: "mixed303",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-303',
      type: "image",
      name: "mixed 303",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-2995.50, -133.32, 3992.54]
      },
      infoHotspots: [
        {
          vec3: [-3808.32, -2096.88, -2450.57],
          target: "mixed302",
          title: "GALERIA MISTA 302",
          type: 'link',
          direction: {
            vec3: [-2856.93, -49.57, 4096.01],
          },
        },
        {
          vec3: [3748.07, -1989.81, 2633.85],
          target: "mixed304",
          title: "GALERIA MISTA 304",
          type: 'link',
          direction: {
            vec3: [-3352.01, -148.73, 3701.11],
          },
        },
        {
    ...
    },
    {
      id: "mixed304",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-304',
      type: "image",
      name: "mixed 304",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-3560.61, -564.26, -3450.25]
      },
      infoHotspots: [
        {
        ...
        },
        {
          ...
          type: 'link',
          direction: {
            vec3: [-4202.85, -131.19, -2686.53],
          },
        },
        {
          vec3: [-2979.27, -1936.50, 3509.66],
          target: "mixed305",
          title: "GALERIA MISTA 305",
          type: 'link',
          direction: {
    ...
    },
    {
      id: "mixed305",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-305',
      type: "image",
      name: "mixed 305",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-3567.16, -582.46, 3440.66]
      },
      infoHotspots: [
        {
        ...
        },
        {
          ...
          type: 'link',
          direction: {
            vec3: [3538.36, -277.98, -3507.59],
          },
        },
        {
          vec3: [3525.73, -2072.99, 2859.59],
          target: "mixed306",
          title: "GALERIA MISTA 306",
          type: 'link',
          direction: {
    ...
    },
    {
      ...
      infoHotspots: [
        ...
        },
        {
          ...
          type: 'link',
          direction: {
            vec3: [-3731.02, -233.81, -3312.19],
          },
        },
        {
          vec3: [4768.41, -1454.51, 236.94],
          target: "mixed307",
          title: "GALERIA MISTA 307",
          type: 'link',
          direction: {
            vec3: [4675.81, 99.29, 1741.24],
          },
        },
        {
    ...
    },
    {
      id: "mixed307",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-307',
      type: "image",
      name: "mixed 307",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-1462.99, -13.18, 4776.74]
      },
      infoHotspots: [
        {
          vec3: [-4189.94, -2536.50, -976.30],
          target: "mixed306",
          title: "GALERIA MISTA 306",
          type: 'link',
          direction: {
            vec3: [-4895.02, -218.13, -957.79],
          },
        },
        {
          vec3: [4551.71, -1360.29, 1538.70],
          target: "mixed308",
          title: "GALERIA MISTA 308",
          type: 'link',
          direction: {
            vec3: [4918.01, 68.17, 850.28],
          },
        },
        {
    ...
    },
    {
      id: "mixed308",
      groupId: 'mixed',
      src: 'MIXED-GALLERY-308',
      type: "image",
      name: "mixed 308",
      faceSize: 6144,
      initialViewParameters: {
        vec3:[-514.10, 84.01, 4969.76]
      },
      infoHotspots: [
        {
          vec3: [-4666.17, -1712.60, -500.71],
          target: "mixed307",
          title: "GALERIA MISTA 307",
          type: 'link',
          direction: {
            vec3: [-4747.72, -256.86, -1534.36],
          },
        },
        {
          vec3: [4680.27, -1589.42, 701.81],
          target: "mixed309",
          title: "GALERIA MISTA 309",
          type: 'link',
          direction: {
            vec3: [4946.99, -187.17, 637.47],
          },
        },
        {
